...
let questions = [
    {
        question: "How many heading tags in HTML?",
        options: ['3', '5', '8', '6'],
        answer: "6"
    },

    {
        question: "Choose heading tag.",
        options: ['h1', 'p', 'span'],
        answer: "h1"
    },

    {
        question: "Which of is not markup language?",
        options: ['HTML', 'XML', 'Java', 'Markdown'],
        answer: "Java"
    },
];
...
function startQuiz() {
  const username = document.getElementById("username").value;
    //အစမှာ user inputက space ပါရင်ဖြုတ်ပေးတာ
  if (username.trim() === "") {
  ...
  document.getElementById("start-container").style.display = "none";  //ရှိနေတဲ့ဟာကိုဖြောက်ခိုင်းတာ(hidden)
  document.getElementById("quiz-container").style.display = "block";  //တခြားတစ်ခုအစားထည့်လိုက်တာ  //ရှိနေတဲ့ဟာလေးပါ်လာတာ visible

  // Shuffle the questions to randomize the quiz
  //လှည့်တာ,ရောတာ miss together
